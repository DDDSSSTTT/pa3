...
var loop_counter = 0;
var obj_field_type_idx = new Map();
var classes = new Map();
        ...
        case "method":
            if (expr.tag == "method") {
                ...
                if (anno_obj != "int" && anno_obj != "none" && anno_obj != "bool") {
                    var method_stmts = __spreadArray(__spreadArray([], argInstrs, true), ["call $".concat(expr.name, "$").concat(anno_obj.class)], false);
                }
            }
            return method_stmts;
        case "getfield":
...
function codeGenFunDef(m) {
    ...
    var params = m.params.map(function (p) { return "(param $".concat(p.name, " i32)"); }).join(" ");
...
function tcExpr(e, classes, functions, variables) {
    ...
    switch (e.tag) {
        ...
        case "method":
            ...
            if (newObj.a != "int" && newObj.a != "bool" && newObj.a != "none") {
                ...
                if (classdata.tag == "class") {
                    ...
                    argTyps.forEach(function (t, i) {
                        if (t.name != "self" && !assignableTo(t.typ, newArgs[i].a)) {
                            throw "Arg Types mismatch for ".concat(t, " and ").concat(i);
                        }
                    });
                }
                else {
            ...
            return __assign(__assign({}, e), { a: "none", obj: newObj, args: newArgs });
        case "getfield":
            var cls_name;
            if (e.obj.tag == "id") {
                cls_name = e.obj.name;
...
function tcStmt(s, classes, functions, variables, currentReturn) {
    ...
    switch (s.tag) {
        ...
        case "class": {
            var bodyvars_2 = new Map(variables.entries());
            s.fields.forEach(function (vi) { tcStmt(vi, classes, functions, bodyvars_2, "none"); });
            ...
            s.methods.forEach(function (mds, name) {
                ...
                var result = tcStmt(stmt_from_mds, classes, functions, bodyvars_2, mds.ret);
