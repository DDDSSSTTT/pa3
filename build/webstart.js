...
function codeGenStmt(stmt, locals, global_vars) {
    switch (stmt.tag) {
        case "define":
            ...
            var stmts = stmt.body.map(function (s) { return codeGenStmt(s, withParamsAndVariables_1, global_vars); }).flat();
...
function traverseType(s, t) {
    switch (t.type.name) {
        case "VariableName":
            ...
            if (name_1 !== "int" && name_1 !== "none" && name_1 !== "bool") {
