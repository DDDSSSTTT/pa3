...
function traverseType(s, t) {
    switch (t.type.name) {
        case "VariableName":
            ...
            if (!supportedTypes.includes(name_1)) {
                throw new Error("Unknown VariableName type: " + name_1);
            }
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.assignableTo = exports.isObject = exports.tcLiteral = exports.tcProgram = exports.tcStmt = exports.tcExpr = exports.tcParams = exports.tcVarInits = void 0;
var ast_1 = __webpack_require__(/*! ./ast */ "./ast.ts");
            ...
            switch (e.obj.tag) {
                case "id":
                    ...
                    if (obj_type == "bool" || obj_type == "int" || obj_type == "none") {
                        throw new Error("The Type of ".concat(e.obj.name, " should be an obj"));
                    }
                    else {
