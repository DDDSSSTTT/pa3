...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.create_obj = exports.compile = exports.codeGenStmt = exports.codeGenClass = exports.codeGenFunDef = exports.codeGenExpr = exports.opStmts = exports.runwatsrc = void 0;
            ...
            if (expr.tag == "method") {
                ...
                if (anno_obj != "int" && anno_obj != "none" && anno_obj != "bool") {
                    ...
                    if (eobj.tag == "method") {
                        ...
                        var classdata = classes.get(eobj.obj.a.class);
                    ...
                    if (eobj.tag == "id" || eobj.tag == "method" || eobj.tag == "getfield" || eobj.tag == "call") {
                        ...
                        if (eobj_stmt.length > 0) {
                            ...
                            method_stmts = __spreadArray(__spreadArray(__spreadArray([], eobj_stmt, true), argInstrs, true), ["call $".concat(expr.name, "$").concat(tmp_name), "local.set $scratch"], false);
                        }
                        else {
...
function create_obj(obj_name, classdata, locals) {
    var initvals = [];
    var tmp_obj_name;
    if (obj_name == "none") {
        // Call class without an obj assignment
        tmp_obj_name = "RESERVED_".concat(unassigned_cls);
        unassigned_cls += 1;
    ...
    classdata.fields.forEach(function (f, index) {
        ...
        if (f.tag != "assign") {
            ...
            if (obj_field_type_idx.get(tmp_obj_name) === undefined) {
                obj_field_type_idx.set(tmp_obj_name, new Map());
            }
    ...
    if (classdata.methods.size > 0) {
        classdata.methods.forEach(function (func, f_name) {
            var new_name = "".concat(f_name, "$").concat(tmp_obj_name);
        ...
        if (classdata.methods.has("__init__")) {
            init_method = "(call $__init__$".concat(tmp_obj_name, ")");
        }
    ...
    return_str = __spreadArray(__spreadArray([], initvals, true), [
        ...
        "(global.set $".concat(tmp_obj_name, ")")
    ], false);
    ...
    return_str.push("(global.get $".concat(tmp_obj_name, ")"));
    return return_str;
}
exports.create_obj = create_obj;
